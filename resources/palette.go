...
var extendedPalette = []color.Color{
	...
	0x37: rgbmix(db16Palette[0x2], db16Palette[0xa], 1.0/3.0),
	0x38: rgbmix(db16Palette[0x2], db16Palette[0xa], 2.0/3.0),
	...
	0x3d: rgbmix(db16Palette[0x0], db16Palette[0xa], 2.0/3.0),
	0x3e: rgbmix(db16Palette[0x8], db16Palette[0xa], 1.0/3.0),
	0x3f: rgbmix(db16Palette[0x8], db16Palette[0xa], 2.0/3.0),
...
var extendedUnditherer = map[uint8]struct{ c1, c2 uint8 }{
	...
	0x28: {0x3b, 0x02}, 0x82: {0x02, 0x3b},
	0x0a: {0x3c, 0x3d}, 0xa0: {0x3d, 0x3c},
	0x8a: {0x3e, 0x3f}, 0xa8: {0x3f, 0x3e},
